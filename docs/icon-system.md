...
- Render the source from `app/` with `magick -background none public/keelhouse-app-icon.svg -resize 1024x1024 resources/branding/keelhouse-app-icon.png`, then regenerate native bundle assets with `npx tauri icon resources/branding/keelhouse-app-icon.png`; do not hand-edit referenced bundle sizes.
