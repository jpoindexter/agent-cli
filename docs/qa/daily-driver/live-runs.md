...
- **Raw-terminal boundary:** Raw terminal replaced the center chat surface and toggled back without becoming duplicate chat content. Optional multi-pane raw-terminal isolation remains covered separately by `session-pane-isolation.md`.
